...
public class ProviderController {
    ...
    public Map<String,Object> provider01(){
        ...
        resultMap.put("msg","002-eureka-client-provider 7002 provider01 请求成功...");
    ...
    public Map<String,Object> provider02(@PathVariable("id") String id , @PathVariable String username){
        ...
        resultMap.put("code",10000);
        resultMap.put("msg","002-eureka-client-provider 7002 provider02 请求成功...");
...
//                                         String uname,
        ...
        resultMap.put("code",10000);
        resultMap.put("msg","002-eureka-client-provider 7002 provider03 请求成功...");
//        resultMap.put("data",id+" "+username+" "+age+" "+uname);
    ...
    public Map<String,Object> provider04(@PathVariable("id") String id ,
        ...
        resultMap.put("code",10000);
        resultMap.put("msg","002-eureka-client-provider 7002 provider04 请求成功...");
        resultMap.put("data",id+" "+username);
...
//    @PostMapping("/05/{id}/{username}")
    public Map<String,Object> provider05(@PathVariable("id") String id ,
        ...
        resultMap.put("code",10000);
        resultMap.put("msg","002-eureka-client-provider 7002 provider05 请求成功...");
        resultMap.put("data",id+" "+username);
    ...
    public Map<String,Object> provider06(@PathVariable("id") String id ,
        ...
        resultMap.put("code",10000);
        resultMap.put("msg","002-eureka-client-provider 7002 provider06 请求成功...");
    ...
    public Map<String,Object> provider07(@PathVariable("id") String id ,
        ...
        resultMap.put("code",10000);
        resultMap.put("msg","002-eureka-client-provider 7002 provider07 请求成功...");
        resultMap.put("data",id+" "+name);
        resultMap.put("paramMap",paramMap);
